...
Spawning.L5_1800_Worker = [MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE,
    WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK,
    CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY];
Spawning.L6_2300_Worker = [MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE,
...
Spawning.ROLE_SENTINEL = 'sentinel';
Spawning.CASTE_WORKER = 'worker';
Spawning.CASTE_ROVER = 'rover';
Spawning.CASTE_CLAIM = 'claim';
Spawning.ROLES = [Spawning.ROLE_HARVESTER, Spawning.ROLE_UPGRADER, Spawning.ROLE_BUILDER, Spawning.ROLE_PAVER, Spawning.ROLE_CLAIM, Spawning.ROLE_MINER, Spawning.ROLE_COURIER, Spawning.ROLE_INFANTRY, Spawning.ROLE_ROAMER, Spawning.ROLE_SENTINEL];
