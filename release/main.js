System.register("caste.worker", [], function (exports_1, context_1) {
    "use strict";
...
System.register("util.source", [], function (exports_2, context_2) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_2("default", SourceUtil);
        }
    };
});
System.register("role.mining", ["util.source", "caste.worker"], function (exports_3, context_3) {
    "use strict";
    var __moduleName = context_3 && context_3.id;
    var util_source_1, caste_worker_1, Miner;
    return {
        setters: [
            function (util_source_1_1) {
                util_source_1 = util_source_1_1;
            },
            function (caste_worker_1_1) {
                caste_worker_1 = caste_worker_1_1;
            }
        ],
        execute: function () {
            Miner = class Miner {
            ...
            exports_3("default", Miner);
        }
    };
});
System.register("role.harvester", ["caste.worker", "role.mining"], function (exports_4, context_4) {
    "use strict";
    var __moduleName = context_4 && context_4.id;
    var caste_worker_2, role_mining_1, Harvester;
    return {
        setters: [
            function (caste_worker_2_1) {
                caste_worker_2 = caste_worker_2_1;
            },
            function (role_mining_1_1) {
                role_mining_1 = role_mining_1_1;
            }
        ],
        execute: function () {
            ...
            exports_4("default", Harvester);
        }
    };
});
System.register("role.upgrader", ["util.source"], function (exports_5, context_5) {
    "use strict";
    var __moduleName = context_5 && context_5.id;
    var util_source_2, Upgrader;
    return {
        setters: [
            function (util_source_2_1) {
                util_source_2 = util_source_2_1;
            }
        ],
        execute: function () {
            ...
            exports_5("default", Upgrader);
        }
    };
});
System.register("role.builder", [], function (exports_6, context_6) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_6("default", Builder);
        }
    };
});
System.register("role.paver", ["caste.worker", "role.mining"], function (exports_7, context_7) {
    "use strict";
    var __moduleName = context_7 && context_7.id;
    var caste_worker_3, role_mining_2, Paver;
    return {
        setters: [
            function (caste_worker_3_1) {
                caste_worker_3 = caste_worker_3_1;
            },
            function (role_mining_2_1) {
                role_mining_2 = role_mining_2_1;
            }
        ],
        execute: function () {
            Paver = class Paver {
            ...
            exports_7("default", Paver);
        }
    };
});
System.register("role.spawn", [], function (exports_8, context_8) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_8("default", Claim);
        }
    };
});
System.register("role.courier", ["caste.worker"], function (exports_9, context_9) {
    "use strict";
    var __moduleName = context_9 && context_9.id;
    var caste_worker_4, Courier;
    return {
        setters: [
            function (caste_worker_4_1) {
                caste_worker_4 = caste_worker_4_1;
            }
        ],
        execute: function () {
            Courier = class Courier extends caste_worker_4.default {
                static run(creep) {
            ...
            exports_9("default", Courier);
        }
    };
});
System.register("Traveler", [], function (exports_10, context_10) {
    "use strict";
    var __moduleName = context_10 && context_10.id;
    var Traveler, REPORT_CPU_THRESHOLD, DEFAULT_MAXOPS, DEFAULT_STUCK_VALUE, STATE_PREV_X, STATE_PREV_Y, STATE_STUCK, STATE_CPU, STATE_DEST_X, STATE_DEST_Y, STATE_DEST_ROOMNAME;
    return {
        setters: [],
        execute: function () {
            Traveler = class Traveler {
            ...
            exports_10("Traveler", Traveler);
            REPORT_CPU_THRESHOLD = 1000;
            DEFAULT_MAXOPS = 20000;
            DEFAULT_STUCK_VALUE = 2;
            STATE_PREV_X = 0;
            STATE_PREV_Y = 1;
            STATE_STUCK = 2;
            STATE_CPU = 3;
...
System.register("task.spawning", [], function (exports_11, context_11) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_11("default", Spawning);
        }
    };
});
System.register("task.towers", [], function (exports_12, context_12) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_12("default", Towers);
        }
    };
});
System.register("main", ["role.harvester", "role.upgrader", "role.builder", "role.paver", "role.spawn", "role.courier", "role.mining", "Traveler", "task.spawning", "task.towers"], function (exports_13, context_13) {
    "use strict";
    ...
    var start, profiling, role_harvester_1, prev, now, role_upgrader_1, role_builder_1, role_paver_1, role_spawn_1, role_courier_1, role_mining_3, traveler, task_spawning_1, task_towers_1, MAX_CREEPS, module;
    return {
        setters: [
            function (role_harvester_1_1) {
                role_harvester_1 = role_harvester_1_1;
            },
            function (role_upgrader_1_1) {
                role_upgrader_1 = role_upgrader_1_1;
            },
            function (role_builder_1_1) {
                role_builder_1 = role_builder_1_1;
            },
            function (role_paver_1_1) {
                role_paver_1 = role_paver_1_1;
            },
            function (role_spawn_1_1) {
                role_spawn_1 = role_spawn_1_1;
            },
            function (role_courier_1_1) {
                role_courier_1 = role_courier_1_1;
            },
            function (role_mining_3_1) {
                role_mining_3 = role_mining_3_1;
            },
            function (traveler_1) {
                traveler = traveler_1;
            },
            function (task_spawning_1_1) {
                task_spawning_1 = task_spawning_1_1;
            },
            function (task_towers_1_1) {
                task_towers_1 = task_towers_1_1;
            }
        ],
        execute: function () {
